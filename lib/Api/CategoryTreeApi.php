...
namespace OpenAPI\EbayTaxonomyApiClient\Api;
...
use OpenAPI\EbayTaxonomyApiClient\ApiException;
use OpenAPI\EbayTaxonomyApiClient\Configuration;
use OpenAPI\EbayTaxonomyApiClient\HeaderSelector;
...
class CategoryTreeApi
{
     ...
     *
     * @param  string $category_tree_id The unique identifier of the eBay category tree. The category tree ID for an eBay marketplace can be retrieved using the &lt;b&gt;getDefaultCategoryTreeId&lt;/b&gt; method. (required)
     *
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayTaxonomyApiClient\Model\GetCategoriesAspectResponse
     */
     ...
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayTaxonomyApiClient\Model\GetCategoriesAspectResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchItemAspectsWithHttpInfo($category_tree_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayTaxonomyApiClient\Model\GetCategoriesAspectResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayTaxonomyApiClient\Model\GetCategoriesAspectResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayTaxonomyApiClient\Model\GetCategoriesAspectResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayTaxonomyApiClient\Model\GetCategoriesAspectResponse',
     ...
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayTaxonomyApiClient\Model\CategorySubtree
     */
    public function getCategorySubtree($category_id, $category_tree_id, $accept_encoding = null)
    {
        list($response) = $this->getCategorySubtreeWithHttpInfo($category_id, $category_tree_id, $accept_encoding);
        return $response;
    }
     ...
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayTaxonomyApiClient\Model\CategorySubtree, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategorySubtreeWithHttpInfo($category_id, $category_tree_id, $accept_encoding = null)
    {
        $request = $this->getCategorySubtreeRequest($category_id, $category_tree_id, $accept_encoding);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayTaxonomyApiClient\Model\CategorySubtree' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayTaxonomyApiClient\Model\CategorySubtree', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayTaxonomyApiClient\Model\CategorySubtree';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayTaxonomyApiClient\Model\CategorySubtree',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCategorySubtreeAsync($category_id, $category_tree_id, $accept_encoding = null)
    {
        return $this->getCategorySubtreeAsyncWithHttpInfo($category_id, $category_tree_id, $accept_encoding)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCategorySubtreeAsyncWithHttpInfo($category_id, $category_tree_id, $accept_encoding = null)
    {
        $returnType = '\OpenAPI\EbayTaxonomyApiClient\Model\CategorySubtree';
        $request = $this->getCategorySubtreeRequest($category_id, $category_tree_id, $accept_encoding);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCategorySubtreeRequest($category_id, $category_tree_id, $accept_encoding = null)
    {
     ...
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayTaxonomyApiClient\Model\CategorySuggestionResponse
     */
     ...
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayTaxonomyApiClient\Model\CategorySuggestionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategorySuggestionsWithHttpInfo($category_tree_id, $q)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayTaxonomyApiClient\Model\CategorySuggestionResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayTaxonomyApiClient\Model\CategorySuggestionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayTaxonomyApiClient\Model\CategorySuggestionResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayTaxonomyApiClient\Model\CategorySuggestionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayTaxonomyApiClient\Model\CategoryTree
     */
    public function getCategoryTree($category_tree_id, $accept_encoding = null)
    {
        list($response) = $this->getCategoryTreeWithHttpInfo($category_tree_id, $accept_encoding);
        return $response;
    }
     ...
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayTaxonomyApiClient\Model\CategoryTree, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCategoryTreeWithHttpInfo($category_tree_id, $accept_encoding = null)
    {
        $request = $this->getCategoryTreeRequest($category_tree_id, $accept_encoding);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayTaxonomyApiClient\Model\CategoryTree' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayTaxonomyApiClient\Model\CategoryTree', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayTaxonomyApiClient\Model\CategoryTree';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayTaxonomyApiClient\Model\CategoryTree',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCategoryTreeAsync($category_tree_id, $accept_encoding = null)
    {
        return $this->getCategoryTreeAsyncWithHttpInfo($category_tree_id, $accept_encoding)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCategoryTreeAsyncWithHttpInfo($category_tree_id, $accept_encoding = null)
    {
        $returnType = '\OpenAPI\EbayTaxonomyApiClient\Model\CategoryTree';
        $request = $this->getCategoryTreeRequest($category_tree_id, $accept_encoding);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCategoryTreeRequest($category_tree_id, $accept_encoding = null)
    {
        // verify the required parameter 'category_tree_id' is set
        if ($category_tree_id === null || (is_array($category_tree_id) && count($category_tree_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayTaxonomyApiClient\Model\GetCompatibilityMetadataResponse
     */
     ...
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayTaxonomyApiClient\Model\GetCompatibilityMetadataResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCompatibilityPropertiesWithHttpInfo($category_tree_id, $category_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayTaxonomyApiClient\Model\GetCompatibilityMetadataResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayTaxonomyApiClient\Model\GetCompatibilityMetadataResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayTaxonomyApiClient\Model\GetCompatibilityMetadataResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayTaxonomyApiClient\Model\GetCompatibilityMetadataResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayTaxonomyApiClient\Model\GetCompatibilityPropertyValuesResponse
     */
     ...
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayTaxonomyApiClient\Model\GetCompatibilityPropertyValuesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCompatibilityPropertyValuesWithHttpInfo($category_tree_id, $compatibility_property, $category_id, $filter = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayTaxonomyApiClient\Model\GetCompatibilityPropertyValuesResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayTaxonomyApiClient\Model\GetCompatibilityPropertyValuesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayTaxonomyApiClient\Model\GetCompatibilityPropertyValuesResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayTaxonomyApiClient\Model\GetCompatibilityPropertyValuesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $marketplace_id The unique identifier of the eBay marketplace for which the category tree ID is requested. For a list of supported marketplace IDs, see &lt;a href&#x3D;\&quot;/api-docs/commerce/taxonomy/static/supportedmarketplaces.html\&quot;&gt;Marketplaces with Default Category Trees&lt;/a&gt;. (required)
     *
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayTaxonomyApiClient\Model\BaseCategoryTree
     */
     ...
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayTaxonomyApiClient\Model\BaseCategoryTree, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDefaultCategoryTreeIdWithHttpInfo($marketplace_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayTaxonomyApiClient\Model\BaseCategoryTree' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayTaxonomyApiClient\Model\BaseCategoryTree', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayTaxonomyApiClient\Model\BaseCategoryTree';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayTaxonomyApiClient\Model\BaseCategoryTree',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDefaultCategoryTreeIdRequest($marketplace_id)
    {
     ...
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayTaxonomyApiClient\Model\AspectMetadata
     */
     ...
     * @throws \OpenAPI\EbayTaxonomyApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayTaxonomyApiClient\Model\AspectMetadata, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemAspectsForCategoryWithHttpInfo($category_id, $category_tree_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayTaxonomyApiClient\Model\AspectMetadata' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayTaxonomyApiClient\Model\AspectMetadata', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayTaxonomyApiClient\Model\AspectMetadata';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayTaxonomyApiClient\Model\AspectMetadata',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
